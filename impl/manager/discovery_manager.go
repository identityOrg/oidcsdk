...
func (d *DefaultManager) ProcessDiscoveryEP(writer http.ResponseWriter, _ *http.Request) {
	...
	metadata := DiscoveryMetadata{
		...
		IntrospectionEndpoint:             combinePath(*issuerUrl, "introspection"),
		RevocationEndpoint:                combinePath(*issuerUrl, "revocation"),
		UserInfoEndpoint:                  combinePath(*issuerUrl, "revocation"),
